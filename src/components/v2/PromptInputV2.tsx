...
import type { ChangeEventHandler, FormEvent, KeyboardEvent } from "react";
...
export default function PromptInputV2({
  value,
  onChange,
  onSubmit,
  isSending,
    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <textarea
          ...
          rows={1}
          className="w-full resize-none bg-transparent text-sm leading-5 text-[#111] outline-none placeholder:capitalize placeholder:text-[#4f5059]/80"
        />
      </div>
